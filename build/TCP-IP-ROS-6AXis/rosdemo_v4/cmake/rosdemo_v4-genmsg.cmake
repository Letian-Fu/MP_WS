...
get_filename_component(_filename "/home/roboert/MP_WS/src/TCP-IP-ROS-6AXis/rosdemo_v4/srv/EnableRobot.srv" NAME_WE)
add_custom_target(_rosdemo_v4_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rosdemo_v4" "/home/roboert/MP_WS/src/TCP-IP-ROS-6AXis/rosdemo_v4/srv/EnableRobot.srv" ""
)

get_filename_component(_filename "/home/roboert/MP_WS/src/TCP-IP-ROS-6AXis/rosdemo_v4/srv/DisableRobot.srv" NAME_WE)
add_custom_target(_rosdemo_v4_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rosdemo_v4" "/home/roboert/MP_WS/src/TCP-IP-ROS-6AXis/rosdemo_v4/srv/DisableRobot.srv" ""
)

get_filename_component(_filename "/home/roboert/MP_WS/src/TCP-IP-ROS-6AXis/rosdemo_v4/srv/ClearError.srv" NAME_WE)
add_custom_target(_rosdemo_v4_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rosdemo_v4" "/home/roboert/MP_WS/src/TCP-IP-ROS-6AXis/rosdemo_v4/srv/ClearError.srv" ""
)

get_filename_component(_filename "/home/roboert/MP_WS/src/TCP-IP-ROS-6AXis/rosdemo_v4/srv/GetErrorID.srv" NAME_WE)
add_custom_target(_rosdemo_v4_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rosdemo_v4" "/home/roboert/MP_WS/src/TCP-IP-ROS-6AXis/rosdemo_v4/srv/GetErrorID.srv" ""
)

get_filename_component(_filename "/home/roboert/MP_WS/src/TCP-IP-ROS-6AXis/rosdemo_v4/srv/MovJ.srv" NAME_WE)
add_custom_target(_rosdemo_v4_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rosdemo_v4" "/home/roboert/MP_WS/src/TCP-IP-ROS-6AXis/rosdemo_v4/srv/MovJ.srv" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rosdemo_v4)
  install(CODE "execute_process(COMMAND \"/home/roboert/anaconda3/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rosdemo_v4\")")
  # install generated code
  install(
