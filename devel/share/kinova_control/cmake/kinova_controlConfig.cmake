...
if("TRUE" STREQUAL "TRUE")
  set(kinova_control_SOURCE_PREFIX /home/roboert/MP_WS/src/kinova-ros/kinova_control)
  set(kinova_control_DEVEL_PREFIX /home/roboert/MP_WS/devel)
  ...
  set(kinova_control_INSTALL_PREFIX /home/roboert/MP_WS/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kinova_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/roboert/MP_WS/src/kinova-ros/kinova_control/${idir}'.  ${_report}")
    endif()
