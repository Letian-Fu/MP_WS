...
int main(int argc, char **argv)
{
    ...
    target_a << 0.84,1.131,-0.866,-0.566,-2.115,0;  // 点 A
    target_b << -0.91,1.309,-0.735,-0.574,-0.608,0;  // 点 B

    // 横向障碍物
    // target_a << -0.5,-0.9,-0.537,1.328,-0.519,0;  // 点 A
    // target_b << -0.6,0.9,-0.072,0.044,-0.959,0;  // 点 B
