#ifndef GP_PLANNER_OPTIMIZERSETTING_H
#define GP_PLANNER_OPTIMIZERSETTING_H
...
/// general setting of all trajectory optimizers
struct OptimizerSetting{
    ...
    gtsam::Vector joint_pos_limits_up, joint_pos_limits_down;  // joint position limits
    ...
    bool final_iter_no_increase;   // value is guaranteed not increase at last
                                    // iteration
    ...
    explicit OptimizerSetting(size_t system_dof);
    ...
    void set_joint_pos_limits_up(const gtsam::Vector& v) {
        joint_pos_limits_up = v;
    }
    void set_joint_pos_limits_down(const gtsam::Vector& v) {
        joint_pos_limits_down = v;
    }
...
#endif //GP_PLANNER_OPTIMIZERSETTING_H